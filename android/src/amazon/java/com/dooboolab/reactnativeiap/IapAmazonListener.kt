package com.dooboolab.reactnativeiap
...
class IapAmazonListener(private val reactContext: ReactContext) : PurchasingListener {
    val TAG = "IapAmazonListener"
            ...
            ProductDataResponse.RequestStatus.SUCCESSFUL -> {
                ...
                DoobooUtils.instance
                    .resolvePromisesForKey(
                        IapAmazon.Companion.PROMISE_GET_PRODUCT_DATA,
                        items
                    )
            }
            ...
            PurchaseUpdatesResponse.RequestStatus.SUCCESSFUL -> {
                ...
                if (response.hasMore()) {
                    ...
                    if (purchases.size > 0 && promiseItem != null) {
                        DoobooUtils.instance
                            .resolvePromisesForKey(
                                IapAmazon.Companion.PROMISE_BUY_ITEM,
                                promiseItem
                            )
                    }
                    DoobooUtils.instance
                        .resolvePromisesForKey(
                            IapAmazon.Companion.PROMISE_QUERY_PURCHASES,
                            true
                        )
                    DoobooUtils.instance
                        .resolvePromisesForKey(
                            IapAmazon.Companion.PROMISE_QUERY_AVAILABLE_ITEMS,
                            availableItems
                        )
    ...
    override fun onPurchaseResponse(response: PurchaseResponse) {
        ...
        when (status) {
            ...
            PurchaseResponse.RequestStatus.ALREADY_PURCHASED -> {
                ...
                DoobooUtils.instance
                    .rejectPromisesForKey(
                        IapAmazon.Companion.PROMISE_BUY_ITEM, errorCode, debugMessage, null
                    )
            }
    ...
    override fun onUserDataResponse(response: UserDataResponse) {
        ...
        when (status) {
            UserDataResponse.RequestStatus.SUCCESSFUL -> {
                ...
                item.putString("userJsonAmazon", userData.toJSON().toString())
                DoobooUtils.instance
                    .resolvePromisesForKey(IapAmazon.Companion.PROMISE_GET_USER_DATA, item)
            }
            UserDataResponse.RequestStatus.NOT_SUPPORTED ->
                DoobooUtils.instance
                    .rejectPromisesForKey(
                        IapAmazon.Companion.PROMISE_GET_USER_DATA,
